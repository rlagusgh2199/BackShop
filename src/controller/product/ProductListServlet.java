...
public class ProductListServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            products = productDAO.getAllProducts(); // 상품 목록을 가져옵니다.
            ...
            session.setAttribute("categoryCounts", categoryCounts); // 카테고리 수 저장

            // JSP로 포워딩하여 상품 목록과 카테고리 수를 전달
            response.sendRedirect(request.getContextPath() + "/maneger_page/maneger_product.jsp");
